...
// Tu código acá:
// Una forma
/* document.querySelector("#createdBy").innerHTML = document.querySelector("#createdBy").innerHTML +  " Pipe"; */
// otra forma
document.querySelector("#createdBy").innerHTML += " Pipe";
// ultima forma
/* let span = document.querySelector("#createdBy");
span.innerHTML = span.innerHTML; + " Pipe" */
//
...
/* // ToDo { description: "barrer", complete: false}
const newTodo = new ToDo("barrer")
console.log(newTodo.completeToDo()) // ToDo {desc, comp, compleTD} */
//
...
//    <span id=1 className="ToDoText">
//       barrer
//    </span>
// </div >
//
function buildToDo(todo, index) {
  // todo -> ToDo { description: "barrer", complete: false}
  // index -> numero
  // Tu código acá:
...
function addToDo() {
  ...
  let newToDo = new ToDo(value); // "barrer" -> {description: "barrer", c}
...
function completeToDo(event) {
  ...
  // Tu código acá:
  //  toDoItems es el array que contiene las toDos
  // Por tanto debemos recorrerlo para encontrar cual es la todo a modificar
  // toDoItems[index]; -> {description, complete}
